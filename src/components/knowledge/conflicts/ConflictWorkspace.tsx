...
// --- TYPES & INTERFACES ---
export type ConflictTypeKey = 'schema' | 'content_contradiction' | 'content_conflict' | 'content_duplicate' | 'content_update';
...
// --- CONSTANTS & DATA TRANSLATIONS ---
const CONFLICT_TYPE_LABELS: Record<ConflictTypeKey, { title: string; desc: string }> = {
  schema: {

...
type FilterPolicyType = 'natural_language' | 'exact_word';
...
const INITIAL_FILTER_POLICIES: FilterPolicy[] = [
  {
    id: 'FP-001',
...
const BASE_EXTRACTION_POLICY = `Extract all named entities including:

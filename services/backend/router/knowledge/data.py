...
from services.backend.UI_model.data import RequestUpdateDocument
from services.backend.dependencies.ui_context import get_ui_context, svc
from services.backend.pipeline.kb_ui_operation.document_ops import (
...
async def promote_document_route(
    ...
    result = await promote_document(
        ...
        data_id=data_id,
        target=body.current_tier.lower() if body.current_tier else "",
